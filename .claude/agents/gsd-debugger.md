...
<required_reading>
@D:/Project/FlightAgent/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Project/FlightAgent/.claude
                  → checks D:/Project/FlightAgent/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Project/FlightAgent/.claude/get-shit-done
                  → writes to D:/Project/FlightAgent/.claude/get-shit-done/hooks/
...
@D:/Project/FlightAgent/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/Project/FlightAgent/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "D:/Project/FlightAgent/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "D:/Project/FlightAgent/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "D:/Project/FlightAgent/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
