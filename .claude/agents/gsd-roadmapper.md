...
Reference full template: `D:/Project/FlightAgent/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Project/FlightAgent/.claude/get-shit-done/templates/state.md`.
