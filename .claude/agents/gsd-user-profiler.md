...
<reference>
@D:/Project/FlightAgent/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Project/FlightAgent/.claude/get-shit-done/references/user-profiling.md` to load:
