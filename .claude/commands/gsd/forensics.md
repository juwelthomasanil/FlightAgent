...
<execution_context>
@D:/Project/FlightAgent/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @D:/Project/FlightAgent/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
