...
Knowledge graph is disabled. To activate:
  ...
  node D:/Project/FlightAgent/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node D:/Project/FlightAgent/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node D:/Project/FlightAgent/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "D:/Project/FlightAgent/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: D:/Project/FlightAgent/.claude/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"D:/Project/FlightAgent/.claude/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
