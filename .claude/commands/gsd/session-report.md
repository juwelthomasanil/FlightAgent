...
<execution_context>
@D:/Project/FlightAgent/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @D:/Project/FlightAgent/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
