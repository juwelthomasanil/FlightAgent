...
```bash
AUDITOR_MODEL=$(node "D:/Project/FlightAgent/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read D:/Project/FlightAgent/.claude/agents/gsd-eval-auditor.md for instructions.
