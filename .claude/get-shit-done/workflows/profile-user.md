...
```bash
cp "D:/Project/FlightAgent/.claude/get-shit-done/USER-PROFILE.md" "D:/Project/FlightAgent/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="D:/Project/FlightAgent/.claude/USER-PROFILE.backup.md"
```
